#!/bin/bash
################################################################################
# Author:   crombiecrunch/LowKey 
#
# Program:
#   Install yiimp on Ubuntu 16.04 running Nginx, MariaDB, and php7.x
# BTC Donation: 1CYA9AnAZ1Bn5Abjz3PtnZKSgcF8xhf4uK
#
################################################################################
output() {
    printf "\E[0;33;40m"
...
output ""
    read -e -p "Enter time zone (e.g. Asia/Kuala_Lumpur) : " TIME
    ...
    clear
    output "If you found this helpful, please donate to BTC Donation: 1CYA9AnAZ1Bn5Abjz3PtnZKSgcF8xhf4uK"
    output ""
...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    sudo ufw allow 12454/tcp
    sudo ufw allow 12455/tcp
    sudo ufw allow 13454/tcp
    sudo ufw allow 13455/tcp
    sudo ufw allow 13564/tcp
    sudo ufw allow 13565/tcp
    ...
    cd ~
    git clone https://github.com/LowKey88/yiimp.git
...
' | sudo -E tee /etc/yiimp/keys.php >/dev/null 2>&1
    ...
    output ""
    output "BTC Donation: 1CYA9AnAZ1Bn5Abjz3PtnZKSgcF8xhf4uK"
    output ""
...
define('"'"'YAAMP_BTCADDRESS'"'"', '"'"'1CYA9AnAZ1Bn5Abjz3PtnZKSgcF8xhf4uK'"'"');
define('"'"'YAAMP_SITE_URL'"'"', '"'"''"${server_name}"''"'"');
define('"'"'YAAMP_STRATUM_URL'"'"', YAAMP_SITE_URL); // change if your stratum server is on a different host
define('"'"'YAAMP_SITE_NAME'"'"', '"'"'GoByte Official Pool'"'"');
...
define('"'"'NICEHASH_API_KEY'"'"','"'"'68cf0bcc-511c-4320-b0f1-f9271d6ff3c0'"'"');
define('"'"'NICEHASH_API_ID'"'"','"'"'165055'"'"');
define('"'"'NICEHASH_DEPOSIT'"'"','"'"'3Lcd7EsaSKZZbmjWscyE2EGcU4JrUJ8fmn'"'"');
...
output ""
output "If you found this script helpful please consider donating some BTC Donation: 1CYA9AnAZ1Bn5Abjz3PtnZKSgcF8xhf4uK"
